...
namespace Paycompute.Percistance.Migrations
{
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    EmoployeeId = table.Column<int>(type: "int", nullable: false),
                    ...
                    Tac = table.Column<decimal>(type: "Money", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PaymentRecords_Employees_EmoployeeId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PaymentRecords_EmoployeeId",
